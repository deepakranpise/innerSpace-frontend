...
<body>
  <div class="invoice-box">
    <section>
      <div class="header">
        <div>
          <img src="./public/images/logos/Picture.png" alt="logo" height="80px" />
        </div>
        <div class="title">
          Delivery Challan
        </div>
        <div>
          <div>
            <img src="/public/images/logos/tline.png" alt="logo" height="50px" />
          </div>
          <div style="margin-left: 11px;">
            <img style=" margin-top: -8px;" src="/public/images/logos/kb.png" alt="logo" height="40px" width="90px" ; />
          </div>
        </div>
      </div>
    </section>
